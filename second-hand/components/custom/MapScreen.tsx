...
import { View, StyleSheet, Dimensions, TouchableOpacity, SafeAreaView, StatusBar } from 'react-native';
			...
			<View>
				...
				<View style={[styles.button_container, globalStyles.background_blue]}>
					<TouchableOpacity onPress={closeMap} style={styles.button}>
						<Icon name={"close"} size={35} color={'white'} type="font-awesome" />
					</TouchableOpacity>
					<TouchableOpacity onPress={handleAddress} style={styles.button}>
						<Icon name={"save"} size={35} color={'white'} type="font-awesome" />
					</TouchableOpacity>
					<TouchableOpacity onPress={removeAddress} style={styles.button}>
						<Icon name={"trash"} size={35} color={'white'} type="font-awesome" />
					</TouchableOpacity>
				</View>
			</View>
		</SafeAreaView>
